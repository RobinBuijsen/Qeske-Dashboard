...
const EnergyFlow = () => {
  ...
  useEffect(() => {
    ...
    // **Nodes**
    const nodes = [
      { id: "Koolstofarm", x: 100, y: 50, color: "#2ecc71", value: "52,7 kWh", icon: "🌿" },
      { id: "Zonne-energie", x: 350, y: 50, color: "#f1c40f", value: "17,5 kWh", icon: "☀️" },
      { id: "Net", x: 100, y: 225, color: "#3498db", value: "112,5 kWh", icon: "⚡" },
      { id: "Thuis", x: 600, y: 225, color: "#2ecc71", value: "129,9 kWh", icon: "🏠" },
      { id: "Batterij", x: 350, y: 400, color: "#BD5176", value: "0,1 kWh", icon: "🔋" }
    ];
